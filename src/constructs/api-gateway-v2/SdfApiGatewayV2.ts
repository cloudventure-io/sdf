...
import { OperationObjectSchema, extractOperationSchema } from "./extractOperationSchema"
...
export interface SdfApiGatewayV2Config<T extends object> {
  ...
  lambdaConfig?: Omit<LambdaFunctionConfig, "handler" | "runtime" | "role" | "functionName">
}
...
export class SdfApiGatewayV2<OperationType extends object = object> extends Construct {
  ...
  private async renderValidator(
    ...
    const moduleCode = standaloneCode(ajv, ajv.compile(schema.properties.request))
