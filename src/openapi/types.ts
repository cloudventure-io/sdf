...
export type OperationObject<T extends object> = OpenAPIV3.OperationObject<T> & {
...
export type PathItemObject<T extends object> = PathItemObjectBase & {
  [method in OpenAPIV3.HttpMethods]?: OperationObject<T>
}

export type PathsObject<T extends object> = {
  [pattern: string]: PathItemObject<T>
}

export interface AwsApiKeySecurityScheme extends OpenAPIV3.ApiKeySecurityScheme {
...
export type SecuritySchemeObject = OpenAPIV3.SecuritySchemeObject | AwsApiKeySecurityScheme
...
export interface Document<OperationType extends object> extends OpenAPIV3.Document<OperationType> {
