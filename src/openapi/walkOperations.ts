...
export interface OperationHandlerOptions<OperationType extends object> {
  pathPattern: string
...
export interface walkSpecOptions<OperationType extends object> {
  document: Document<OperationType>

  operationHandler: (operation: OperationHandlerOptions<OperationType>) => void
}

export const walkOperations = <T extends object>({ document, operationHandler }: walkSpecOptions<T>) => {
